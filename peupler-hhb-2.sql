...
INSERT INTO compte (id_type, num_compte, date_fermer, date_ouvrir, solde) VALUES (2, 5, '2012-10-27', '2012-10-27', -1200);
-- -----------------------------------------------------------------------------
--       TABLE : POSSEDER
-- -----------------------------------------------------------------------------
...
VALUES (1,1,'2012-04-12',2,120,true,false,null);
------------------------------------------------------------------------------
--       TABLE : CHEQUE
-- -----------------------------------------------------------------------------
...
--       TABLE : OPERATION (ex2)
-- -----------------------------------------------------------------------------
INSERT INTO operation (id_operation, num_compte, date, num_compte_vers,num_cb,num_chequier ,designation, type_operation, montant) 
VALUES (1, 1, '2012-10-27', 1,1,null,'Ouverture compte', 'CREDIT', 100);

INSERT INTO operation (id_operation, num_compte, date, num_compte_vers,num_cb,num_chequier ,designation, type_operation, montant) 
VALUES (2, 2, '2012-10-27', 1,null,1,'Ouverture compte', 'DEBIT', 100);
